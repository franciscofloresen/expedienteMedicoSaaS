...
class TestNoteSigning:
    ...
    async def test_create_nota_returns_pending_status(self, client_tenant_a: AsyncClient):
    ...
    async def test_sign_nonexistent_nota_returns_404(self, client_tenant_a: AsyncClient):
    ...
    async def test_verify_nonexistent_nota_returns_404(self, client_tenant_a: AsyncClient):
...
class TestSignatureVerification:
    ...
    async def test_verification_endpoint_returns_correct_schema(self, client_tenant_a: AsyncClient):
