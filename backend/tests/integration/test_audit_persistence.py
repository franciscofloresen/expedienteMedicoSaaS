...
class TestAuditPersistence:
    ...
    async def test_get_request_creates_audit_entry(self, client_tenant_a: AsyncClient):
    ...
    async def test_audit_entry_has_request_metadata(self, client_tenant_a: AsyncClient):
    ...
    async def test_post_request_creates_audit_entry(self, client_tenant_a: AsyncClient):
