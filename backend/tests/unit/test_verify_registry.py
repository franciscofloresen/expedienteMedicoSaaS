...
def test_fotografias_is_registered() -> None:
    assert "fotografias" in available_actions()


def test_preferencias_is_registered() -> None:
    assert "preferencias" in available_actions()
