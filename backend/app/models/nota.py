...
class Nota(Base):
    ...
    firmado_por: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("tenants.id"))
    ...
    expediente: Mapped["Expediente"] = relationship("Expediente", back_populates="notas")
