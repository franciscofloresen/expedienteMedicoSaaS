      ...
      <main style={{ flex: 1, padding: '4rem 5%' }}>
        <article style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: 'var(--bg-card)', padding: '4rem', borderRadius: '24px', boxShadow: 'var(--shadow-sm)' }}>
          ...
          <div style={{ color: 'var(--text-main)', lineHeight: 1.8, fontSize: '1.05rem' }}>
            ...
            <h3 className="section-title">1. Naturaleza del Servicio y Modelo de Responsabilidad Compartida</h3>
            <p>
            ...
            <h3 className="section-title">2. Infraestructura en la Nube, Cifrado e Integridad</h3>
            <p>
            ...
            <h3 className="section-title">3. Cumplimiento de la NOM-004 y NOM-024</h3>
            <p>
            ...
            <h3 className="section-title">1. Datos Personales Recabados</h3>
            ...
            <h3 className="section-title">3. Transferencia de Datos</h3>
            <p>
            ...
            <h3 className="section-title">4. Derechos ARCO</h3>
            <p>
